...
<div id="wx-jcrop-dialog" class="reveal-modal">
    ...
    <div id="wx-jcrop-dialog-loading" style="display: none;"><img src="<?php echo JURI::base(); ?>components/com_weever/static/img/loading.gif" /> Saving...</div>
...
<div class="section-container auto section-subnav" data-section>
	...
	<section id="logo_design">
		<p class="title" data-section-title>
			<a href="#"><?php echo 'logo design';//echo __( 'logo design', 'weever' ); ?></a>
		</p> 
	...
	<section id="launch_screen">
		<p class="title" data-section-title>
			<a href="#"><?php echo 'launch screens';//echo __( 'launch screens', 'weever' ); ?></a>
		</p>
		<div class="content" data-section-content>
	...
	<section id="install_icon">
		<p class="title" data-section-title><a href="#"><?php echo 'installation';//echo __( 'installation', 'weever' ); ?></a></p>
		<div class="content" data-section-content>
	...
	<section id="custom_branding">
		<p class="title" data-section-title><a href="#"><?php echo 'custom branding';//echo __( 'custom branding', 'weever' ); ?></a></p>
		<div class="content" data-section-content>
	...
	<!-- Advanced -->
	<section id="advanced">
		<p class="title" data-section-title><a href="#"><?php echo 'advanced';//echo __( 'advanced', 'weever' ); ?></a></p>
		<div class="content" data-section-content>
			<!-- advanced.tpl.html -->
		</div>
	</section>
